...
namespace MyLeasing.Web.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public OwnersController(IOwnerRepository ownerRepository, UserHelper userHelper)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Document,FirstName,LastName,FixedPhone,CellPhone,Address")] Owner owner)
        {
            if (ModelState.IsValid)
            {
                ...
                owner.User = await _userHelper.GetUserByEmailAsync("alex@gmail.com");
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var owner = _ownerRepository.GetByIdAsync(id.Value);
            if (owner == null)
            {
                return NotFound();
            }
